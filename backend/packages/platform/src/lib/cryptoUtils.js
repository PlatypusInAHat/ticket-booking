...
const hmacSha256 = (value, purpose = 'generic') => crypto
...
const isHashedSecret = (value = '') => String(value).startsWith(`${HASH_PREFIX}:`);

const hashForConstantTimeCompare = (value = '') => crypto
  .createHash('sha256')
  .update(String(value))
  .digest();
